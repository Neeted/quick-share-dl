...
Googleドライブ / Dropbox / OneDrive / MediaFire のファイル共有ページを開くと自動的にダウンロードを開始します。新規タブで開いた場合にはダウンロードを開始後に自動でタブを閉じます。
...
- OneDrive: onedrive.live.com/* タブを開いて15秒以内にダウンロードボタンが表示された場合
